...
APP_ICON = "data:image/png;base64,"


def applogo(size=28):
    return (f'<img src="{APP_ICON}" width="{size}" height="{size}" '
            f'style="border-radius:7px;flex:0 0 auto;margin-right:10px" alt="">')


def appbar(title, icons, back=False, logo=False):
    lead = f'<div class="iconbtn">{icon(I["back"])}</div>' if back else ''
    if logo:
        lead = applogo()
    acts = "".join(f'<div class="iconbtn">{icon(I[n])}</div>' for n in icons)
    pad = 'padding: 0 4px;' if back else ('padding: 0 16px;' if logo else '')
...
def tab_strip(names, active):
    cells = []
    for n in names:
        on = n == active
        colour = "var(--primary)" if on else "var(--on-var)"
        cells.append(f'<div class="tab{" on" if on else ""}" title="{n}">'
                     f'{icon(I[TAB_ICON[n]], size=22, color=colour)}</div>')
    return '<div class="tabs">' + "".join(cells) + '</div>'


def tabs(active):
    return tab_strip(["Songs", "Albums", "Artists", "Queue"], active)
...
def mini(playing=True, progress=42):
  ...
  <div class="mini-row" style="gap:0;padding:8px 8px 8px 16px">
...
{appbar("Barcarole", ["search", "sort", "refresh", "gear"], logo=True)}
{tab_strip(["Songs", "Artists", "Queue", "Playlists"], "Songs")}
...
SETTINGS_EXTRA = """\n    .chip { height: 32px; padding: 0 12px; border-radius: 16px; border: 1px solid var(--outline); display: flex; align-items: center; font-size: 13px; color: var(--on); }\n    .chip.on { background: var(--primary); color: var(--on-primary); border-color: var(--primary); }\n"""
...
<div class="list">
  ...
  <div style="padding:8px 16px 0">
    <div class="t1">Text size</div>
    <div class="t2" style="margin-top:2px">Below 100% the text shrinks, so more rows fit.</div>
  </div>
  <div style="display:flex;gap:8px;padding:10px 16px 14px">
    <div class="chip on">100%</div><div class="chip">90%</div>
    <div class="chip">80%</div><div class="chip">70%</div>
  </div>
  ...
  <div style="display:flex;align-items:center;gap:16px;padding:8px 16px;height:64px">
    <div class="meta"><div class="t1">Remove duplicates</div>
      <div class="t2">6 extra copies to review</div></div>
    <div style="color:var(--on-var);transform:rotate(180deg)">{icon(I["back"], 20)}</div>
  </div>
  ...
  <div style="padding:0 16px 8px">
    <div class="t1" style="font-size:14px">Barcarole 0.2.0</div>
    <div class="t2" style="margin-top:4px">Offline player. No network permission, no accounts, no telemetry.</div>
  </div>
</div>
</div>"""
(OUT / "Settings.dc.html").write_text(page(body, SETTINGS_EXTRA), encoding="utf-8")
...
# ---------------------------------------------------------------- Playlists : 3 directions

def tabs5(active):
    return tab_strip(["Songs", "Artists", "Queue", "Playlists"], active)

EXTRA = """
    .chip {
      height: 36px; padding: 0 14px; border-radius: 18px; border: 1px solid var(--outline);
      display: flex; align-items: center; font-size: 13px; color: var(--on);
    }
    .chip.on { background: var(--primary); color: var(--on-primary); border-color: var(--primary); }
    .grp { font-size: 11px; letter-spacing: .09em; text-transform: uppercase; color: var(--on-var); }
    .tile {
      background: var(--surface-hi); border-radius: 12px; padding: 12px 14px;
      display: flex; flex-direction: column; justify-content: space-between; height: 84px;
    }
    .tile b { font-size: 22px; font-weight: 500; font-variant-numeric: tabular-nums; }
